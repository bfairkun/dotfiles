...
5. If user asks to see it on remote control: run `post_plot_to_slack <filepath>` (save as PNG first — Slack previews PNG inline, not PDF) or use `Read` tool to embed inline
